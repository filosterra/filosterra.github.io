<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:state="http://panax.io/state">
	...
	<xsl:template match="/">
		...
		<script type="text/javascript" defer="defer" src="./mapselection.js?v=20230601">loteador.inicializar()</script>
		<style>
			<![CDATA[
#Mapa .map {
	...
	width: 100%;
		...
		<img src="/assets/desarrollos/{$state:desarrollo}/loteador.png" orgwidth="3800" width="500" border="0" usemap="#map" class="map" />
		<map name="map">
